...
generate_and_annotate(all_path = './generated_images/',
                      t_path = './generated_labels/',
                      df_path = './generated_df/',
                      num = 500000)

check_directory = Path('./generated_labels/')
check_files = [f for f in check_directory.iterdir() if f.is_file()]

if check_files:
    print(f"First file in generated_labels: {check_files[0].name}")
else:
    print("No files found in generated_labels")
