...
def generate_roi(parquet_name, labels_name, name = 'default_name', file_location = '/uscms/home/azhou/smart-pixels-ml/'):
    ...
    df_true = pd.read_parquet(labels_name)
...
def generate_and_annotate(all_path = '/uscms/home/azhou/nobackup/sahi/train/images/', t_path = '', df_path = '', num=10):
    ...
    random_recon3d = 'recon3D_d' + str(NUM) + '.parquet'
    random_labels = 'labels_d' + str(NUM) + '.parquet'


    for i in range(num):
        id_num = i

        temp_dict = generate_roi(parquet_name = random_recon3d, labels_name = random_labels, name=f'TAG_generated_event_{id_num}', file_location = all_path)
        ...
        #label.txt writer
        id_labels_path = t_path + f'TAG_generated_event_{id_num}.txt'
        ...
        id_df_path = df_path + f'TAG_df_generated_event_{id_num}.txt'
...
generate_and_annotate(all_path = 'TAG_generated_images/',
                      t_path = 'TAG_generated_labels/',
                      df_path = 'TAG_generated_df/',
                      num = 5000)
